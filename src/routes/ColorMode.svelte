...
<div on:click={swapMode} on:keypress={undefined} aria-checked="true" aria-label="dark mode toggle" role="switch" tabindex="0" class="m-0 p-0">
    <Icon icon="tdesign:fog-night" class="dark:visible cursor-pointer text-black dark:text-white hover:text-black/70 dark:hover:text-white/70"/>
</div>
{:else}
<div on:click={swapMode} on:keypress={undefined} class="m-0 p-0" aria-checked="true" aria-label="dark mode toggle" role="switch" tabindex="0">
    <Icon icon="tdesign:fog-sunny" class="visible cursor-pointer text-black dark:text-white hover:text-black/70 dark:hover:text-white/70"/>
</div>
{/if}