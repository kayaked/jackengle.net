...
<div class="h-auto w-full absolute top-14 bg-neutral-300/90 dark:bg-neutral-950/90 backdrop-blur-lg z-20 hidden py-5 grid-rows-1 md:hidden p-navbar gap-5  text-gray-900 dark:text-white border-solid border-b border-gray-400 dark:border-neutral-700/30" >
    <nav>
